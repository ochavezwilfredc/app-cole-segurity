...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                ...
                R.id.nav_vehiculos, R.id.nav_servicios_chofer,
    ...
    fun actualizarDatos(){
        ...
        if (d!=""){
            ...
            txtDNI?.setText("${datos.getString("documento_identidad")} - ${datos.getString("rol")}")
            val rolid = datos.getInt("rol_id")
            when(rolid){
                3-> {
                    menu?.findItem(R.id.nav_vehiculos)?.isVisible = true
                    menu?.findItem(R.id.nav_servicios_chofer)?.isVisible = true

                }
                4-> {
                    menu?.findItem(R.id.nav_empresas)?.isVisible = true
                    menu?.findItem(R.id.nav_servicio_aceptacion)?.isVisible = true
                    menu?.findItem(R.id.nav_servicio_historial)?.isVisible = true
                    menu?.findItem(R.id.nav_servicio_registrar)?.isVisible = true
                }
            }
